package com.example.vaadintestgridtree.ui;
 ...
 */
public class VaadintestgridtreeTest extends TestBenchTestCase {
    @Rule
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/VaadinTestGridTree");
    }
